...
//  football-app
//
//  Created by James on 07/01/2024.
//
...
protocol PersistentStore {
    ...
    func count<ResultType>(_ fetchRequest: NSFetchRequest<ResultType>) -> AnyPublisher<Int, Error>
    func fetch<ResultType, V>(_ fetchRequest: NSFetchRequest<ResultType>,
                     map: @escaping (ResultType) throws -> V?) -> AnyPublisher<LazyList<V>, Error>
